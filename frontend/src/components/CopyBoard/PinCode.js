    ...
    <div className="w-full max-w-[16rem]">
      <div className="relative">
        ...
        <input
          ...
          value={data?.Address?.Pincode ? data?.Address?.Pincode : "" }  ////it is a placeholer 
          disabled
          readOnly
        />
        <CopyToClipboard text={data?.Address?.Pincode ? data?.Address?.Pincode : ""} onCopy={() => setCopied(true)}>
